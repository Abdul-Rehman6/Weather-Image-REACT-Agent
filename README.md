...
This repository features a powerful Jupyter Notebook (`Image_Weather_Ai_Agent.ipynb`) that demonstrates a sophisticated **LangChain ReAct Agent** capable of complex decision-making by leveraging three distinct types of tools: **multimodal vision**, **real-time API data**, and **general web search**.

The Agent utilizes the **ReAct (Reasoning and Acting)** framework to dynamically select the right tool, execute a sequence of actions, and synthesize the final answer. This showcase highlights how to build agents that seamlessly transition between knowledge domains and input modalities.
...
2.  **Install Dependencies:**
    ...
    Install the necessary packages (e.g., `langchain-openai`, `langchain-tavily`, `python-dotenv`).
...
3.  **Set Up Environment Variables:**
    ...
    # Note: If the key is not moved to .env, it is hardcoded in the notebook.
...
The Agent uses a ReAct pattern with GPT-4o-mini as the core reasoning engine.

### 1. Custom Tools and Initialization
